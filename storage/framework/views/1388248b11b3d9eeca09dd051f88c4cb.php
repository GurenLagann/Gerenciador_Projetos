...
<?php $__env->startSection('breadcrumb', 'Painel'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[minmax(88px,auto)]">
        ...
        <div class="sm:col-span-2 lg:row-span-2 rounded-2xl p-6 border flex flex-col" style="background:var(--surface); border-color:var(--border);">
            ...
            <div class="text-5xl font-medium mt-3" style="font-family:var(--font-mono); color:white; font-variant-numeric:tabular-nums;"><?php echo e($stats['in_progress']); ?></div>
            <div class="text-sm mt-1 mb-5" style="color:var(--muted-1);">projetos ativos agora</div>
            <div class="space-y-2.5 mt-auto max-w-sm">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activeProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('projects.show', $p)); ?>" class="flex items-center gap-2.5 text-sm hover:opacity-80 transition-opacity">
                    <span class="w-1.5 h-1.5 rounded-full flex-shrink-0" style="background:<?php echo e($p->status->color); ?>;"></span>
                    <span class="flex-1 min-w-0 truncate" style="color:var(--text);"><?php echo e($p->name); ?></span>
                    <span class="tabular-nums flex-shrink-0" style="font-family:var(--font-mono); font-size:.75rem; color:var(--muted-2);"><?php echo e($p->progress); ?>%</span>
                </a>
        ...
        <div class="sm:col-span-2 lg:row-span-2 rounded-2xl p-6 border" style="background:var(--surface); border-color:var(--border);">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusCounts->isEmpty()): ?>
            ...
            <div class="flex items-center gap-6 max-w-xs">
                ...
                <div class="flex-1 min-w-0 space-y-1.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statusCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-2 text-sm">
                        <span class="w-1.5 h-1.5 rounded-full flex-shrink-0" style="background:<?php echo e($entry->status->color); ?>;"></span>
                        <span class="flex-1" style="color:var(--text);"><?php echo e($entry->status->label); ?></span>
                        <span class="tabular-nums" style="font-family:var(--font-mono); color:var(--muted-2);"><?php echo e($entry->count); ?></span>
                    </div>
        ...
        <div class="rounded-2xl p-5 border flex flex-col justify-center" style="background:var(--surface); border-color:var(--border);">
            <div class="text-2xl font-medium" style="font-family:var(--font-mono); color:white;"><?php echo e($stats['total_projects']); ?></div>
            <div class="text-sm mt-0.5" style="color:var(--muted-1);">Total de Projetos</div>
        </div>
        <div class="rounded-2xl p-5 border flex flex-col justify-center" style="background:var(--surface); border-color:var(--border);">
            <div class="text-2xl font-medium" style="font-family:var(--font-mono); color:white;"><?php echo e($stats['done']); ?></div>
        ...
        <div class="sm:col-span-2 lg:col-span-3 lg:row-span-2 rounded-2xl p-6 border" style="background:var(--surface); border-color:var(--border);">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('projects.index')); ?>" class="text-xs font-medium hover:opacity-80 transition-opacity" style="color:#818cf8;">Ver todos &rarr;</a>
            </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4043512852-0', $__key);
...
?>
            ...
            <div class="flex gap-3 overflow-x-auto pb-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('projects.show', $project)); ?>"
                    ...
                    <div class="text-sm font-semibold truncate mb-2" style="color:white;"><?php echo e($project->name); ?></div>
                    <span class="text-[11px] px-1.5 py-0.5 rounded font-medium"
                        style="background:<?php echo e($project->status->bg); ?>; color:<?php echo e($project->status->color); ?>;"><?php echo e($project->status->label); ?></span>
                    <div class="flex items-center justify-between mt-3">
                        <span class="text-[11px]" style="color:var(--muted-2);">progresso</span>
                        <div class="w-7 h-7 rounded-full flex items-center justify-center"
                            style="background: conic-gradient(<?php echo e($project->status->color); ?> <?php echo e($project->progress * 3.6); ?>deg, var(--border-2) 0deg);">
                            <div class="w-[18px] h-[18px] rounded-full flex items-center justify-center text-[9px]" style="font-family:var(--font-mono); background:var(--surface-2); color:var(--muted-1);"><?php echo e($project->progress); ?></div>
                        </div>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="sm:col-span-2 lg:col-span-1 lg:row-span-2 rounded-2xl p-6 border" style="background:var(--surface); border-color:var(--border);">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentIdeas->isEmpty()): ?>
            <p class="text-sm" style="color:var(--muted-3);">Nenhuma ideia ainda.</p>
            <?php else: ?>
            <div class="space-y-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentIdeas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('ideas.show', $idea)); ?>" class="flex items-start gap-2.5 p-2 rounded-lg hover:bg-white/[.03] transition-colors">
                    <span class="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-1.5" style="background:<?php echo e($idea->priority->dot); ?>;"></span>
                    <div class="min-w-0">
                        <div class="text-sm leading-snug truncate" style="color:var(--text);"><?php echo e($idea->title); ?></div>
                        <span class="text-[11px] px-1.5 py-0.5 rounded font-medium inline-block mt-1"
                            style="background:<?php echo e($idea->status->bg); ?>; color:<?php echo e($idea->status->color); ?>;"><?php echo e($idea->status->label); ?></span>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
(function () {
    ...
    var ITEMS = <?php echo json_encode($paletteItems, 15, 512) ?>;
