                ...
                <div class="flex items-start justify-between gap-3 mb-3">
                    ...
                    <div class="flex items-center gap-0.5 flex-shrink-0">
                        <button wire:click="pin(<?php echo e($annotation->id); ?>)"
                            ...
                            style="<?php echo e($annotation->pinned ? 'color:#818cf8; background:rgba(99,102,241,.15);' : ''); ?>"
                            title="<?php echo e($annotation->pinned ? 'Desafixar' : 'Fixar'); ?>"
                            aria-label="<?php echo e($annotation->pinned ? 'Desafixar anotação' : 'Fixar anotação'); ?>">
